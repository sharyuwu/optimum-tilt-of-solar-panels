...
the tolerable probability of breakage, the goal is:
\begin{itemize}
\item[GS1:] Predict whether the glass slab will be able to withstand the explosion.
\end{itemize}  
...
\item
  \href{https://github.com/JacquesCarette/literate-scientific-software/tree/master/CaseStudies/glass/Documentation/SRS}
  {GlassBR}
\end{itemize}
\end{frame}
