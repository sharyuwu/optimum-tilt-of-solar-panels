...
\item Latitude: The angle which ranges from 0 $^\circ$ at the Equator to 90$^\circ$ (North or South) at the poles. 
...
\item[ ] PS1: Solar panel, the panel with solar cells that able to absorb solar energy from the sun.
