...
\wss{You don't really want to copy and paste the SRS requirements.  This will
  cause maintenace problems.  Referencing the SRS here should be enough.  You
...
<<<<<<< HEAD
unit testing plan.} \wss{In this section you would also give any details of any
...
plans for static verification of the implementation. Potential techniques
includecode walkthroughs, code inspection, static analyzers, etc.}
>>>>>>> aa80c1a3c0ea659fb15863abb49a7aba0000cc59
...
values for latitude are $-90 \leq \Phi_P \leq 90$. \wss{I've fixed some spelling
  mistakes and spacing mistakes.  Please make an effort for more attention to detail.}\\
...
of latitude, the system activates the error handler. \\  \wss{The test case for
  ...
  correct exception is raised, when it is expected to be raised.}
...
Control: Manual. \wss{So far all of your tests can be automated.  My guess is
  that most of the tests you have indicated as manual can be automated tests.}
...
=======
Output:The expected result wil \wss{proof read} for the given inputs is:\\
Output (1) 0,0,0 doesnot \wss{proof read} exist.\\ 
>>>>>>> aa80c1a3c0ea659fb15863abb49a7aba0000cc59
Output (2) -1,-1,-1 does not exist.\\
 Output(3) 2020.02.29 does not exist\\ 
 Output(4) 2020.02.28 exist\\ 

 \wss{I like the idea of summarizing multiple test cases, but I think you should
 use a table for this.  You also should still give each test a unique id.  As it
is now, you have combined them all in -id3.}
...
\wss{spell check}, the system activates the error handler. \\
>>>>>>> aa80c1a3c0ea659fb15863abb49a7aba0000cc59
...
~input (3) $\Phi_P$: 0\\
=======
Input (1..50)~$\theta_{S_{day}}$: A random  picked rational number \wss{between
  what bounds?}\\
>>>>>>> aa80c1a3c0ea659fb15863abb49a7aba0000cc59
...
~Output (3) Valid \\
=======
\wss{What is the correct output?  You need to explain to the reader how you find
  the value of the correct output.  What is your test oracle?}
...
This test case used the external data from [Landau\cite{Charles2001}] \wss{This
  ...
  If you want to use the author year style, use the Natbib option for BibTeX.}
>>>>>>> aa80c1a3c0ea659fb15863abb49a7aba0000cc59
...
\wss{Use table to summarize your test cases.}
...
test case should require reporting this number.}
...
How test will be performed:
 \begin{itemize}
\item Implement \progname{} on the
virtual machines with the system enviroment of Windows 10, MacOs.  \wss{What is
  the OS and what is the virtual OS?  Why not Linux too?  Virtual box is easy to
install and run.}
\item Run every function of \progname. \wss{What do you mean to run every
