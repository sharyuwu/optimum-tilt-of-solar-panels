...
This test covers the requirements, R1, in section \ref{Objectives}. Based on the SRS document\cite{YS2019}, \progname{}has to identity users' inputs and then assign the values to designated equations or modules.
...
Input (1..50)~$\theta_{S_{day}}$: A random  picked rational number \wss{between what bounds?}\\
...
virtual machines with the system environment of Windows 10, macOS. \wss{What is
