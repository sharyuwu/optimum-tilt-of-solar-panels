...
\begin{description}
\item[Secrets:] The structure \wss{spell check} of the table layout.
\item[Services:] Creates \wss{spell check - there are many spelling mistakes in
    this document}\an{I am sorry about the spelling mistakes} a table.
