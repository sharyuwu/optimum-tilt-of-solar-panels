...
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The initial of the
  input parameter.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The constraint of theinput data.
\item[\refstepcounter{acnum} \actheacnum \label{acInput}:] The format of the
  input parameter.
\item[\refstepcounter{acnum} \actheacnum \label{acOutput}:] The constraint of
the output data.
\item[\refstepcounter{acnum} \actheacnum \label{acOutput}:] The format of the
  output data.
\item[\refstepcounter{acnum} \actheacnum \label{acSolarEnergy}:] How to
calculate the output solar energy.
\item[\refstepcounter{acnum} \actheacnum \label{acDateDuration}:]  How to
calculate the date duration.
\item[\refstepcounter{acnum} \actheacnum \label{acTiltAngle}:] How to calculate
the optimum tilt angle.
\item[\refstepcounter{acnum} \actheacnum \label{acSunIntensity}:] The algorithm
of sun intensity.
\item[\refstepcounter{acnum} \actheacnum \label{acZenithAngle}:] The algorithm
of zenith angle.
\item[\refstepcounter{acnum} \actheacnum \label{acSunDeclination}:] The
algorithm of sun declination angle.
\item[\refstepcounter{acnum} \actheacnum \label{acPlot}:]  The
...
\item [\refstepcounter{mnum} \mthemnum \label{mSEA}:] Solar Energy Output
Module\item [\refstepcounter{mnum} \mthemnum \label{mOTA}:] Optimum Tilt Angle
Module
\item [\refstepcounter{mnum} \mthemnum \label{mSI}:] Sun Intensity Equation
Module
\item [\refstepcounter{mnum} \mthemnum \label{mZA}:] Zenith Angle Equation
Module
\item [\refstepcounter{mnum} \mthemnum \label{mSD}:] Sun Declination Equation
Module
\item [\refstepcounter{mnum} \mthemnum \label{mDD}:] Date Duration Module
...
\begin{figure}[H]
 ...
 \caption{\label{Fig_Hierarchy} Hierarchy}
\end{figure}
...
algorithmcould potentially go here, if that is a decision that is exposed by
theinterface.}
...
\item[Services:]Assigns the input value to its parameter.
\item[Implemented By:] \progname
\end{description}

\subsubsection{Input Verify Module (\mref{mIF})}

\begin{description}
\item[Secrets:]The input values constraint.
\item[Services:]Verifies the input by the input values constraint.
...
\item[Services:]Assigns the output value to its parameter.
\item[Implemented By:] \progname
\end{description}
...
\begin{description}
\item[Secrets:]The equation of calculate the optimal tilt angle.
\item[Services:] Define the optimal tilt angle equation.
\item[Implemented By:] \progname
\end{description}
...
\begin{description}
\item[Secrets:]The equation of calculate the sun intensity.
\item[Services:] Proves the algorithm calculate the Sun Intensity.
...
\begin{description}
\item[Secrets:]The equation of calculate the zenith angle.
\item[Services:] Proves the algorithm calculate the zenith angle.
\item[Implemented By:] \progname
\end{description}
...
\begin{description}
\item[Secrets:]The equation of calculate the sun declination.
\item[Services:]Proves the algorithm calculate the zenith angle.
\item[Implemented By:] \progname
\end{description}
